...
export function ChatPanel() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="px-4 py-2.5 border-b border-[var(--color-border)] shrink-0 flex items-center gap-2">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
            ...
            <div className="mt-6 space-y-2 text-xs text-[var(--color-text-muted)]">
              {[
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-2 rounded-lg border border-[var(--color-border)] hover:border-[var(--color-accent)] hover:text-[var(--color-accent)] transition-colors"
                >
                  "{example}"
                </button>
              ))}
        ...
        {error && (
          <div className="flex items-center gap-2 text-xs text-[var(--color-red)] bg-[var(--color-red-subtle)] rounded-lg px-3 py-2 border border-[var(--color-red-subtle)]">
